$(function() {
		...
		var resizeBooklet = function() {
			var pageWidth = 588;
			var pageHeight = 900; 
			var bookletSide = 74;

			$mybook.each( function(i,v) {
				var allowedWidth = jQuery(v).parent().parent().width();
				var allowedHeight = null; 
					var allowedHeight = $(window).height() - 82;
				...
				jQuery(v).booklet("option","width",(newWidth * 2));
				jQuery(v).booklet("option","height",newHeight);
